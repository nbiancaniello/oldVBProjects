...
Public Class Ej1
    ...
    Private Sub Ej1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim i As Short = 0
        ...
        Try
            ...
            CM.CommandText = "SELECT cod_postal, localidad FROM Localidades"
            CM.Connection = CN
            CN.Open()
            DR = CM.ExecuteReader
            While DR.Read()
