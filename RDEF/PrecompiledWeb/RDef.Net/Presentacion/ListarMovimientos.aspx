<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_ListarMovimientos, App_Web_r2qjsibb" enableEventValidation="false" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblPerteneceExpedienteNumero" runat="server" Text="Perteneciente al Expediente Numero:" CssClass="lblBoldUpperXXS" Width="240px"></asp:Label>
            ...
            <tr>
                <td style="width: 776px; height: 238px">
        <asp:GridView ID="gvMovimientos" runat="server" CssClass="DataGrid" ForeColor="#333333" GridLines="Vertical" Height="95%" Width="95%" AllowPaging="True" OnPageIndexChanging="gvMovimientos_PageIndexChanging" OnPageIndexChanged="gvMovimientos_PageIndexChanged" OnRowDataBound="gvMovimientos_RowDataBound" OnSelectedIndexChanged="gvMovimientos_SelectedIndexChanged">
            ...
            <tr>
                <td style="width: 794px; height: 6px">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:Button ID="btnVolver" runat="server" OnClick="btnVolver_Click" Text="Volver" CssClass="ButtonBlue11px" Width="64px" /></td>
            </tr>
        </table>
    </div>
    </form>
