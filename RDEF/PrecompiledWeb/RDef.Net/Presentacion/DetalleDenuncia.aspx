<%@ page language="C#" autoeventwireup="true" inherits="DetalleDenuncia, App_Web_r2qjsibb" enableEventValidation="false" %>
        ...
        <table style="width: 712px">
            ...
            <tr>
                <td colspan="6" rowspan="4">
                    <asp:TextBox ID="txtDenuncia" runat="server" Height="128px" Width="99%"></asp:TextBox></td>
            </tr>
            <tr>
            </tr>
            <tr>
