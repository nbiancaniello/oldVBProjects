<%@ page language="C#" autoeventwireup="true" inherits="Expedientes, App_Web_r2qjsibb" enableviewstate="true" enableEventValidation="false" %>
...
//                }
		...
		function desabilitarTodo()
		{
			...
			{
				var propiedades ="dialogHeight:360px;" +  "dialogWidth:500px;" + "dialogTop: 20px;" + "dialogLeft: 20px;"
				propiedades += "center:yes; edge:raised; help:no; resizable:no; scroll:yes; status:no; "; 					
				var respuesta = window.showModalDialog("Contactos.aspx?idDenunciante=1","",propiedades); 
...
<body>
    ...
    <div>   
            <table style="width: 712px; height: 40px" border="0" id="tblCabecera">
                <tr>
                    <td style="width: 725px; height: 21px">
                         <asp:Label ID="lbl" runat="server" Text="Nro Expediente: " Width="112px" CssClass="lblBoldUpperXXS"></asp:Label>
                         <asp:Label ID="lblNroExpediente" runat="server" Text="0" Width="72px" CssClass="lblBoldUpperXXS"></asp:Label></td>
                    <td style="width: 862px; height: 21px; text-align: right;">
                         <asp:Label ID="Label1" runat="server" Text="Fecha Ingreso: " CssClass="lblBoldUpperXXS"></asp:Label>
                         <asp:Label ID="lblFechaIngreso" runat="server" CssClass="lblBoldUpperXXS"></asp:Label></td>
                    <td style="width: 1221px; height: 21px; text-align: right;">
                ...
                <tr>
                    <td style="width: 725px; height: 29px;">
                         <asp:Label ID="Label2" runat="server" Text="Atendio: " CssClass="lblBoldUpperXXS"></asp:Label>
                         <asp:DropDownList ID="cboAtendio" runat="server" Width="128px" CssClass="ComboBox" Enabled="False">
                         </asp:DropDownList></td>
                    <td style="width: 862px; height: 29px;">
                         <asp:Label ID="Label4" runat="server" Text="Informante: " CssClass="lblBoldUpperXXS"></asp:Label>
                         <asp:DropDownList ID="cboInformante" runat="server" Width="104px" CssClass="ComboBox" Enabled="False">
                         </asp:DropDownList></td>
                    <td style="width: 1221px; text-align: right; height: 29px;" align="left">
                         <asp:Label ID="Label6" runat="server" Text="Estado: " CssClass="lblBoldUpperXXS"></asp:Label>
                         <asp:Label ID="lblEstado" runat="server" CssClass="lblBoldUpperXXS"></asp:Label>
                         </td>
                    </tr>
           </table>    
           <table style="width: 712px; height: 40px" border="0" id="tblTabs">
                            ...
                            <table id="tblDenunciante" style="width: 707px; height: 330px;" >
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 416px; height: auto">
                                        <asp:TextBox ID="txtTelefono" CssClass="TextBoxTelefono" runat="server" Width="168px" Enabled="False" MaxLength="100"></asp:TextBox></td>
                                    <td style="width: 110px; height: auto">
                                        <asp:Label ID="Label12" runat="server" CssClass="lblBoldUpperXXS" Text="Celular: "></asp:Label></td>
                                    <td style="width: 309px; height: auto">
                                        <asp:TextBox ID="txtCelular" CssClass="TextBoxTelefono" runat="server" Enabled="False" MaxLength="100"></asp:TextBox></td>
                                </tr>
                               <tr>
                                    <td style="width:115px; height:auto">
                                        <asp:Label ID="Label14" runat="server" CssClass="lblBoldUpperXXS" Text="Email: "></asp:Label></td>
                                   <td colspan="3" style="height: auto">
                                       <asp:TextBox ID="txtEmail" CssClass="TextBox" runat="server" Width="336px" Enabled="False" MaxLength="100"></asp:TextBox></td>
                                </tr>
                            </table>
            ...
            <table style="width: 712px; height: 16px" border="0" id="tblBotonera">
                <tr>
                    <td style="width:874px; height: 12px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 874px; height: 12px">
                        <asp:Button ID="btnNuevo" runat="server" Text="Nuevo" Width="96px" Enabled="true" CssClass="ButtonBlue11px" OnClick="btnNuevo_Click" />
                    </td>
                    <td style="width: 848px; height: 12px">
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" Width="96px" Enabled="False" CssClass="ButtonBlue11pxDisable" OnClick="btnModificar_Click" />
                    </td>
                    <td style="width: 848px; height: 12px">
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" Width="96px" Enabled="false" CssClass="ButtonBlue11pxDisable" />
                    </td>
                    <td style="width: 822px; height: 12px">
                        <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" Enabled="false" Width="96px" CssClass="ButtonBlue11pxDisable" OnClick="btnCancelar_Click" />
                    </td>
                    <td style="width: 822px; height: 12px">
                        <asp:Button ID="btnGuardar" runat="server" Text="Guardar" Enabled="false" Width="96px" CssClass="ButtonBlue11pxDisable" OnClick="btnGuardar_Click" />
                    </td>
                    <td style="width: 55px; height: 12px">
                        <asp:Button ID="btnBuscar" runat="server" Text="Buscar" Enabled="true" Width="96px" CssClass="ButtonBlue11px" OnClick="btnBuscar_Click" /></td>
                    <td style="width: 134px; height: 12px; text-align: right;">
                        <asp:Button ID="btnSalir" runat="server" Text="Salir" Enabled="true" Width="96px" CssClass="ButtonBlue11px" OnClick="btnSalir_Click"/></td>
                </tr>
            </table>
