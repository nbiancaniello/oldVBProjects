<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_Personas, DefensorDeploy" enableEventValidation="false" %>
                            ...
                            <tr>
                                <td style="width: 347px; height: 165px">
                                    <asp:GridView ID="GvPersonas" runat="server" CellPadding="4" ForeColor="#333333"
                                        GridLines="None" OnPageIndexChanged="GvPersonas_PageIndexChanged" OnRowDataBound="GvPersonas_RowDataBound" OnSelectedIndexChanged="GvPersonas_SelectedIndexChanged" CssClass="DataGrid" Width="280px" OnPageIndexChanging="GvPersonas_PageIndexChanging">
