<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_Denunciados, DefensorDeploy" enableEventValidation="false" %>
                            ...
                            <tr>
                                <td style="width: 264px; height: 165px">
                                    <asp:GridView ID="GvDenunciados" runat="server" CssClass="DataGrid"
                                        ForeColor="Black" Width="280px" OnPageIndexChanged="GvDenunciados_PageIndexChanged" OnRowDataBound="GvDenunciados_RowDataBound" OnSelectedIndexChanged="GvDenunciados_SelectedIndexChanged" BorderColor="White" BackColor="White" OnPageIndexChanging="GvDenunciados_PageIndexChanging">
