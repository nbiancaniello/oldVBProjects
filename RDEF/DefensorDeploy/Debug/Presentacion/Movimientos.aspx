<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_Movimientos, DefensorDeploy" enableEventValidation="false" %>
        ...
        <table style="width: 776px;height: 336px" id="tblPrincipal">
            ...
            <tr>
                ...
                <td style="height: 29px; width: 151px;">
                    <asp:Button ID="btnFechaRespuesta" runat="server" Text="Fecha Respuesta" Width="112px" CssClass="ButtonBlue11pxDisable" CausesValidation="False" OnClientClick="mostrarFechaRespuesta()" UseSubmitBehavior="False" Enabled="False" /></td>
            ...
            <table width="776">
                <tr>
                    ...
                    <td style="height: auto; width: 81px;">
                        ...
                        <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="ButtonBlue11pxDisable" Enabled="False" OnClick="btnCancelar_Click" /></td>                    <td style="height: 26px; width: 83px;">
                        <asp:Button ID="btnGuardar" runat="server" Text="Guardar" CssClass="ButtonBlue11pxDisable" Enabled="False" OnClick="btnGuardar_Click" /></td>                    <td style="height: 26px; width: 83px;">
