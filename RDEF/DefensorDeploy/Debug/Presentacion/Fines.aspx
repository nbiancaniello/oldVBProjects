<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_Fines, DefensorDeploy" enableEventValidation="false" %>
                        ...
                        <table style="width: 248px; height: 56px">
                            <tr>
                                <td style="width: 264px; height: 165px">
                                    &nbsp;&nbsp;
                                    <asp:GridView ID="GvFines" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanged="GvFines_SelectedIndexChanged" OnRowDataBound="GvFines_RowDataBound" OnSelectedIndexChanged="GvFines_SelectedIndexChanged" CssClass="DataGrid" Height="192px" Width="280px" OnPageIndexChanging="GvFines_SelectedIndexChanging">
