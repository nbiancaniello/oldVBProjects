<%@ page language="C#" autoeventwireup="true" inherits="Consultas, DefensorDeploy" enableviewstate="true" enableEventValidation="false" %>
    ...
    <div id="divPorEmpresa" style="display:none">
        ...
        <table style="width: 716px; height: 88px;">
            <tr>
                ...
                <td style="width: 89px; height: 55px;" valign="top">
                    <asp:Button ID="btnVolver" runat="server" Text="Salir" Width="96px" CssClass="ButtonBlue11px" OnClick="btnVolver_Click" /></td>
