<%@ page language="C#" autoeventwireup="true" inherits="Presentacion_Areas, DefensorDeploy" enableEventValidation="false" %>
                        ...
                        <tr>
                            <td style="width: 264px; height: 165px">
                                <asp:GridView ID="GvAreas" runat="server" CssClass="DataGrid"
                                    ForeColor="DimGray" Height="168px" Width="280px" OnRowDataBound="GvAreas_RowDataBound" OnSelectedIndexChanged="GvAreas_SelectedIndexChanged" OnPageIndexChanged="GvAreas_PageIndexChanged" BackColor="White" OnPageIndexChanging="GvAreas_PageIndexChanging">
