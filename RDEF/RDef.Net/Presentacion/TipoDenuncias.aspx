<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipoDenuncias.aspx.cs" Inherits="Presentacion_TipoDenuncias" %>
                    ...
                    <table style="width: 248px; height: 56px">
                        <tr>
                            <td style="width: 264px; height: 165px">
                                &nbsp;<asp:GridView ID="GvTipoDenuncias" runat="server"
                                    CssClass="DataGrid" ForeColor="Black" Height="168px" Width="280px" OnPageIndexChanged="GvTipoDenuncias_PageIndexChanged" OnRowDataBound="GvTipoDenuncias_RowDataBound" OnSelectedIndexChanged="GvTipoDenuncias_SelectedIndexChanged" OnPageIndexChanging="GvTipoDenuncias_PageIndexChanging" AllowPaging="True">
